...
public class Test13extends TestBase {
	WebDriver driver;
	...
	public void LogInToApp() throws InterruptedException {
		try {
			fileLoc = new FileInputStream("C:\\Users\\josyular\\eclipse-workspace\\SeleniumAssignments\\src\\test\\java\\com\\qa\\utilities\\Testdata.properties");
			prop = new Properties();
			prop.load(fileLoc);
		}catch(Exception e) {
			e.printStackTrace();
	...
	public void validateEmployeeSearch() throws IOException, InterruptedException {
		...
		OrangeOR.EnterEmployeeName("Josyula Ravi");
		OrangeOR.ClickOnSearch();
		
		FName=OrangeOR.getFirstNameText();
		LName=OrangeOR.getLastNameText();
		boolean fNameresult = FName.contains("Josyula");
		boolean lNameresult = LName.contains("Ravi");
